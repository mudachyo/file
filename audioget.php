...
right: 40px;
line-height: .5;
background: linear-gradient(to right, #45688E 45%, transparent 45%, transparent), linear-gradient(to right, transparent, transparent 55%, #45688E 55%);
font-family: serif;
}
blockquote:before {
content: "\201C";
...
<blockquote>
  <p>Никто и ничто не защищено. Не существует совершенной защиты....</p>
  <footer>— <cite>kotanoff</cite></footer>
</blockquote>
<br>
<br>
<br>
<form action="#" method="POST" id="form">
    ...
    <button type="sumbit" class="shorten_button flat_button" id="shorten_btn" style="vertical-align: 0;">Пробить</button>
...
//CONFIGURATION
$login = '77768155028'; //login
$pass = '983256vor'; //password
$path = '/cookies'; //cookies path
